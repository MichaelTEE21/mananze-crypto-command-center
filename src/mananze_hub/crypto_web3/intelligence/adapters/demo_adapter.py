...
from mananze_hub.crypto_web3.intelligence.demo_feed import DEMO_RAW_DOCUMENTS
...
class DemoAdapter(BaseAdapter):
    def fetch(self, limit: int = 20) -> Sequence[RawDocument]:
        ...
        try:
            from mananze_hub.crypto_web3.intelligence.rwa.demo_seed import build_demo_raw_documents
