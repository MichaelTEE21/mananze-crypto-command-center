...
from mananze_hub.crypto_web3.paths import DB_PATH, ensure_dirs
...
def _migrate_schema(conn: sqlite3.Connection) -> None:
    ...
    try:
        from mananze_hub.crypto_web3.partners import migrate_partner_categories
...
def init_db(db_path: Optional[Path] = None) -> None:
    ...
    from mananze_hub.crypto_web3.partners import seed_demo_partners

    seed_demo_partners(db_path)
    from mananze_hub.crypto_web3.exchanges import seed_demo_exchanges
